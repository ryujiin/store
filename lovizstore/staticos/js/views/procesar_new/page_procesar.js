...
define([
    ...
    'headModel',
    'bootstrap'
], function ($, _, Backbone, swig,CarroModel,UserModel,PedidoModel,Header) {
    'use strict';

    var PageProcesar = Backbone.View.extend({
        el:$('#contenido'),
        ...
        changeHeader:function () {
            var titulo = 'Pasarela de Compras';
            var descripcion = 'Pasarela de compras en Loviz DelCarpio®, lovizdc.com';
            Header.set({titulo:titulo,descripcion:descripcion});
        }
    });
    var page = new PageProcesar({
